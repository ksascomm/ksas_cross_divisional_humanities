<?php get_header(); ?>
	<div id="content">
		...
		<div class="brown-bg">
			<div class="row">
				<div class="small-12 large-10 large-push-1 columns events-feed" role="region" aria-label="Events">
					<div class="events">
		...
		<div id="inner-content-2">
			...
			<div class="row">
				<div class="small-12 columns" role="region" aria-label="Humanities Highlights">
				...
				<hr>
			<div class="row">
				<div class="small-12 large-8 columns" role="region" aria-label="Announcements">
					<div class="news-feed">
