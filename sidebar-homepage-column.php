<?php if ( is_active_sidebar( 'homepage3', 'homepage4', 'homepage5' ) ) : ?>
	<div class="row">
	...
	<h3>Who We Serve</h3>
		...
		<?php if ( is_active_sidebar( 'homepage4' ) ) : ?>

			<div id="homepage2" class="large-4 columns" role="complementary">
				<div class="secondary callout">
					<?php dynamic_sidebar( 'homepage4' ); ?>
				</div>
			</div>
		...
		<?php if ( is_active_sidebar( 'homepage5' ) ) : ?>

			<div id="homepage2" class="large-4 columns" role="complementary">
				<div class="primary callout">
					<?php dynamic_sidebar( 'homepage5' ); ?>
				</div>
			</div>
